...
from src.financial.data_sources.yfinance_price import get_yahoo_data
...
# LangChain parser expects Pydantic v2's model_json_schema; shim depending on runtime version.
def _model_json_schema(cls):
    if hasattr(cls, "model_json_schema"):
        return cls.model_json_schema()
    return cls.schema()

FactorSet.model_json_schema = classmethod(_model_json_schema)
FactorPayload.model_json_schema = classmethod(_model_json_schema)
...
# LangChain parser expects Pydantic v2's model_json_schema; shim depending on runtime version.
DateRangePayload.model_json_schema = classmethod(_model_json_schema)
...
def get_oil_impact_from_existing_trends(
    ...
    try:
        ...
        # =================================================================
        print(f"\n{'='*80}")
        print(f"🗓?PHASE 2: Mapping Factors to Date Ranges using LLM")
        print(f"{'='*80}")
