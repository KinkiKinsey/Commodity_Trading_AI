...
async def incremental_update_oil_metrics(
    ...
    try:
        ...
        # Step 3: Generate NEW impact metrics from ALL trends (not just new ones)
        # This is because Oil_Impact_Metrics recalculates everything from trends
        print(f"📊 Step 3: Generating impact metrics from updated trends...")
