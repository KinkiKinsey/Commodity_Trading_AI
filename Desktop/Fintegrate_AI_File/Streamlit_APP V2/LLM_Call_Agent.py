...
Focus on the user's specific query and provide evidence-based analysis."""
    ...
    def get_structured_llm(self, pydantic_model=None, provider: str = None):
        ...
        try:
            ...
            logging.error("Install with: pip install langchain-openai")
            raise ImportError("LangChain required for structured output. Install with: pip install langchain-openai")
        except Exception as e:
