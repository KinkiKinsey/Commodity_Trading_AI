...
class FundamentalSegmentationAgent:
    ...
    def __init__(self, progress_context=None, redis_host: str = None, redis_port: int = None, 
        ...
        # Use default Redis connection if not provided
        revenue_redis_host = redis_host or "redis-16204.fcrce180.us-east-1-1.ec2.redns.redis-cloud.com"
        revenue_redis_port = redis_port or 16204
        revenue_redis_username = redis_username or "default"
        ...
        try:
            self.revenue_read_agent = RevenueSegmentationAnalystAgent(
                ...
                redis_password=revenue_redis_password
            )
            logging.info("✅ Revenue Segmentation Read Agent initialized")
        except Exception as e:
            logging.warning(f"⚠️ Revenue Segmentation Read Agent initialization failed: {e}")
...
"""
    ...
    def call_revenue_read_agent(self, refined_query: str, ticker: str) -> Dict:
        """
        ...
        try:
            ...
            if self.revenue_read_agent:
                result = self.revenue_read_agent.process_natural_query(refined_query, ticker)
...
"""
    ...
    async def process_query(self, query: str, ticker: str) -> Dict:
        ...
        try:
            ...
            # Extract the actual Revenue Read Agent response
